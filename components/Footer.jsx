      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-text">Diseñamos y fabricamos accesorios para marcas y empresas. Cada producto está pensado para que represente bien a quien lo lleva.</p>
            <div className="footer-social">
              <a href="https://www.instagram.com/b2you.team/" className="social-link" aria-label="Instagram" target="_blank" rel="noreferrer">
              ...
              <a href="https://www.instagram.com/b2you.team/" className="social-link" aria-label="Facebook" target="_blank">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="https://wa.me/5491178279281?text=Hola!%20Estoy%20interesado%20en%20uno%20de%20los%20productos%20de%20su%20marca" className="social-link" aria-label="WhatsApp" target="_blank" rel="noreferrer">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/catalogo-b2you.pdf" download className="footer-nav-link footer-catalog-link">Catálogo</a></li>
            </ul>
          </div>
          ...
          <div className="footer-section footer-form-section">
            ...
            <form className="contact-form" id="contactForm" onSubmit={onContactSubmit}>
